...
set data_dir=data\spider
set db_dir=data\spider\database
set dataset_name=spider
set model=bridge
...
set sql_consistency_check=True
set atomic_value_copy=False
set process_sql_in_execution_order=True
...
set num_peek_steps=1000
set num_accumulation_steps=2
set save_best_model_only=True
set train_batch_size=16
set dev_batch_size=24
set encoder_input_dim=1024
set encoder_hidden_dim=400
set decoder_input_dim=400
